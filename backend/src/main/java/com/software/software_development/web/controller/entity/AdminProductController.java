...
@RestController
@RequestMapping(Constants.API_URL + Constants.ADMIN_PREFIX + Constants.PRODUCTS_URL)
...
public class AdminProductController {
    ...
    public ProductDto create(@RequestBody @Valid ProductDto dto) {
        return mapper.toProductDto(productService.create(
                mapper.toProductEntity(dto),
                dto.getOwnerId(),
                dto.getCategoryIds()
        ));
    }
    ...
    public ProductDto update(@PathVariable Long id, @RequestBody @Valid ProductDto dto) {
        return mapper.toProductDto(productService.update(
                id,
                mapper.toProductEntity(dto),
                dto.getOwnerId(),
                dto.getCategoryIds()
    ...
    public ProductDto delete(@PathVariable Long id) {
        return mapper.toProductDto(productService.delete(id));
    }
}
